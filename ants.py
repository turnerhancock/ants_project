...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            if hasattr(insect, 'is_first') and insect.is_first == True:
                return
            # END Problem 13
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        i = 0
        while p is not hive:
            if p.bees and i >= self.min_range and i <= self.max_range:
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        if self.contained_ant == None and self.is_container == True and other.is_container == False:
            return True
        else:
            return False
        # END Problem 9
...
class Water(Place):
    ...
    def add_insect(self, insect):
        ...
        its armor to 0."""
        # BEGIN Problem 11
        Place.add_insect(self, insect = insect)
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        self.is_first = QueenAnt.is_true
    ...
    def double_damage(self):
        p = self.place.exit
        while p is not None:
            if p.ant and p.ant.damage_doubled == False:
                p.ant.damage = p.ant.damage * 2
                p.ant.damage_doubled = True
            if p.ant and hasattr(p.ant, 'contained_ant') and p.ant.contained_ant and p.ant.contained_ant.damage_doubled == False:
                p.ant.contained_ant.damage = p.ant.contained_ant.damage * 2
                p.ant.contained_ant.damage_doubled = True 
            else:
                p = p.exit
    def action(self, colony):
...
def apply_effect(effect, bee, duration):
    ...
    if effect is make_slow:
        bee.slow_count = 3
    if effect is make_scare and bee.been_scared == False:
        bee.scare_count = 2
